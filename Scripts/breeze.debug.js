    ...
    var Validator = (function () {
        ...
        **/
        ...
        @example
            ...
            var custType = metadataStore.getEntityType("Case");
        ...
        @example
            ...
            // v in this case will be a Case entity
            var valFn = function (v) {
            ...
            // Now plug it into Breeze.
            // Assume em1 is a preexisting EntityManager.
            var custType = em1.metadataStore.getEntityType("Case");
        ...
        **/
        ...
        @example
            ...
            // Makes "Region" on Case a required property.
        ...
        **/
        ...
        @example
            ...
            var custType = em1.metadataStore.getEntityType("Case");
            var regionProperty - custType.getProperty("Region");
            // Validates that the value of the Region property on Case will be less than or equal to 5 characters.
        ...
        **/
        ...
        @example
            ...
            var custType = em1.metadataStore.getEntityType("Case");
            var regionProperty - custType.getProperty("Region");
            // Validates that the value of the Region property on Case will be
        ...
        **/
        ...
        @example
            ...
            var custType = em1.metadataStore.getEntityType("Case");
            var regionProperty - custType.getProperty("Region");
            // Validates that the value of the Region property on Case is a string.
        ...
        **/
        ...
        @example
            // Assume em1 is a preexisting EntityManager.
            var custType = em1.metadataStore.getEntityType("Case");
            var caseIdProperty - custType.getProperty("CaseID");
            // Validates that the value of the CaseID property on Case is a Guid.
            caseIdProperty.validators.push(Validator.guid());
        @method guid
        @static
        @return {Validator} A new Validator
        **/
        ...
        @example
            ...
            // Validates that the value of the ElapsedTime property on Case is a duration.
        ...
        **/
        ...
        @example
            ...
            var caseType = em.metadataStore.getEntityType("Case");
            var regionProperty = caseType.getProperty("Region");
            // Validates that the value of Case.Region is 2 char uppercase alpha.
        ...
        **/
        ...
        @example
            // Assume em is a preexisting EntityManager.
            var caseType = em.metadataStore.getEntityType("Case");
            var phoneProperty = caseType.getProperty("phone");
            // Validates that the value of the Case.phone property is phone.
        ...
        **/
        ...
        @example
            ...
            var custType = em.metadataStore.getEntityType("Case");
...
**/
    ...
    ; breeze.makeComplexArray = (function () {
        ...
        /**
         ...
         complexTypes associated with a data property on a single entity or other complex object. i.e. case.orders or order.orderDetails.
...
**/
    ...
    var EntityAspect = (function () {
        ...
        **/
        ...
        @example
            emp.entityAspect.loadNavigationProperty("Entries").then(function (data) {
        ...
        **/
        ...
        @example
            emp.entityAspect.markNavigationPropertyAsLoaded("Entries");
        ...
        **/
        ...
        @example
            var wasLoaded = emp.entityAspect.isNavigationPropertyLoaded("Entries");
    ...
    var ComplexAspect = (function () {
        ...
        @example
            // assume address is a complex property on the 'Case' type
            var aspect = aCase.address.complexAspect;
            // aCase === aspect.parent;
        @class ComplexAspect
        **/
...
**/
    ...
    ; breeze.makePrimitiveArray = (function () {
        ...
        primitive types associated with a data property on a single entity or complex object. i.e. case.invoiceNumbers.
        This collection looks like an array in that the basic methods on arrays such as 'push', 'pop', 'shift', 'unshift', 'splice'
        are all provided as well as several special purpose methods.
        ...
        **/
        ...
        entities associated with a navigation property on a single entity. i.e. case.orders or order.orderDetails.
        This collection looks like an array in that the basic methods on arrays such as 'push', 'pop', 'shift', 'unshift', 'splice'
        are all provided as well as several special purpose methods.
    ...
    var MetadataStore = (function () {
        ...
        **/
        ...
        @example
            ...
            Case.prototype.doFoo() {
                    ...
                }
            // assume em1 is a preexisting EntityManager;
            em1.metadataStore.registerEntityTypeCtor("Case", Case);
            // any queries or EntityType.create calls from this point on will call the Case constructor
            // registered above.
    ...
    var EntityType = (function () {
        ...
        **/
        ...
        @example
            ...
            custType.setProperties( {
                ...
                defaultResourceName: "CasesAndIncludedOrders"
            )};
        @method setProperties
        @param config [object]
        @param [config.autogeneratedKeyType] {AutoGeneratedKeyType}
        ...
        **/
        ...
        @example
            // assume em1 is an EntityManager containing a number of existing entities.
            var custType = em1.metadataStore.getEntityType("Case");
            var caseNameDataProp = custType.getDataProperty("CaseName");
        ...
        **/
        ...
        @example
            // assume em1 is an EntityManager containing a number of existing entities.
            var custType = em1.metadataStore.getEntityType("Case");
            var caseOrdersNavProp = custType.getDataProperty("Entries");
        ...
        **/
        ...
        @example
            ...
            var companyNameProp2 = orderDetailType.getProperty("Order.Case.CompanyName");
    ...
    var KeyGenerator = (function () {
        ...
        */
        ...
        @example
            ...
            var custType = em1.metadataStore.getEntityType("Case");
            var cust1 = custType.createEntity();
            // next line both sets cust1's 'CaseId' property but also returns the value
            var cid1 = em1.generateTempKeyValue(cust1);
            em1.saveChanges().then( function( data) {
              var sameCust1 = data.results[0];
              // cust1 === sameCust1;
              // but cust1.getProperty("CaseId") != cid1
...
**/
        ...
        var Predicate = (function () {
            ...
            **/
            ...
            @example
                ...
                var query = new EntityQuery("Cases").where(p1);
            or
            @example
                var p2 = new Predicate("Region", FilterQueryOp.Equals, null);
                var query = new EntityQuery("Cases").where(p2);
    ...
    ; var EntityQuery = (function () {
        ...
        **/
        ...
        /**
        @example
            var query = new EntityQuery("Cases")
        ...
        **/
        ...
        @example
            ...
            var query = new EntityQuery("Cases").where(pred);
        ...
        **/
        ...
        @example
            var query = new EntityQuery("Cases")
              .where("CompanyName", "startsWith", "C")
              .select("Entries");
        where the result would be an array of objects each with a single "Entries" property that would itself be an array of "Order" entities.
        Composite projections are also possible:
        @example
            var query = new EntityQuery("Cases")
              .where("CompanyName", "startsWith", "C")
              .select("CompanyName, Entries");
        As well as projections involving nested property paths
        @example
            var query = EntityQuery("Entries")
              .where("Case.CompanyName", "startsWith", "C")
              .select("Case.CompanyName, Case, OrderDate");
        @method select
        @param propertyPaths {String|Array of String} A comma-separated (',') string of property paths or an array of property paths.
        ...
        **/
        ...
        @example
            var query = new EntityQuery("Cases")
              .where("CompanyName", "startsWith", "C")
              .expand("Entries");
        will return the filtered cases each with its "Entries" properties fully resolved.
        Multiple paths may be specified by separating the paths by a ','
        @example
            var query = new EntityQuery("Entries")
              .expand("Case, Employee")
        and nested property paths my be specified as well
        @example
            var query = new EntityQuery("Entries")
              .expand("Case, OrderDetails, OrderDetails.Product")
        @method expand
        ...
        **/
        ...
        @example
            var query = new EntityQuery("Cases")
              ...
              .orderBy("CompanyName")
              .inlineCount(true);
        will return the first 20 cases as well as a count of all of the cases in the remote store.
        ...
        **/
        ...
        @example
            var em = new EntityManager(serviceName);
            var query = new EntityQuery("Entries").using(em);
        ...
        **/
        ...
        @example
            // assuming 'cases' is an array of 'Case' entities retrieved earlier.
            var casesQuery = EntityQuery.fromEntities(cases);
        ...
        @example
            // assuming 'case' is a 'Case' entity retrieved earlier.
            var caseQuery = EntityQuery.fromEntities(case);
        will create a query that will return an array containing a single case entity.
        @method fromEntities
        @static
        ...
        **/
        ...
        @example
            // 'employee' is a previously queried employee
            var ordersNavProp = employee.entityType.getProperty("Entries");
            var query = EntityQuery.fromEntityNavigation(employee, ordersNavProp);
        will return a query for the "Entries" of the specified 'employee'.
...
**/
    ...
    var EntityManager = (function () {
        ...
        **/
        ...
        @example
            // assume em1 is an EntityManager containing a number of existing entities.
            // assume cust1 is a case Entity previously attached to em1
        ...
        **/
        ...
        @example
            var em = new EntityManager(serviceName);
            var query = new EntityQuery("Entries").using(FetchStrategy.FromLocalCache);
            em.executeQuery(query).then( function(data) {
                var orders = data.results;
                ... query results processed here
            }).fail( function(err) {
        ...
        **/
        ...
        @example
            ...
            var caseId = em.generateTempKeyValue(custumer);
            // The 'case' entity 'CaseID' property is now set to a newly generated unique id value
            // This property will change again after a successful save of the 'case' entity.
      
            em1.saveChanges().then( function( data) {
                var sameCust1 = data.results[0];
                // cust1 === sameCust1;
                // but cust1.getProperty("CaseId") != caseId
                // because the server will have generated a new id 
                // and the client will have been updated with this 
                // new id.
            })
        ...
        **/
        ...
        @example
            // assume em1 is an EntityManager containing a number of preexisting entities.
            var custType = em1.metadataStore.getEntityType("Case");
            var changedCases = em1.getChanges(custType);
        or to a collection of {{#crossLink "EntityType"}}{{/crossLink}}s
        @example
            // assume em1 is an EntityManager containing a number of preexisting entities.
            var custType = em1.metadataStore.getEntityType("Case");
            var orderType = em1.metadataStore.getEntityType("Order");
            var changedCasesAndOrders = em1.getChanges([custType, orderType]);
        @method getChanges
        @param [entityTypes] {String|Array of String|EntityType|Array of EntityType} The {{#crossLink "EntityType"}}{{/crossLink}}s for which 'changed' entities will be found.
        If this parameter is omitted, all EntityTypes are searched. String parameters are treated as EntityType names.
        ...
        **/
        ...
        @example
            // assume em1 is an EntityManager containing a number of preexisting entities.
            var custType = em1.metadataStore.getEntityType("Case");
            var cases = em1.getEntities(custType);
        or to a collection of {{#crossLink "EntityType"}}{{/crossLink}}s
        @example
            // assume em1 is an EntityManager containing a number of preexisting entities.
            var custType = em1.metadataStore.getEntityType("Case");
            var orderType = em1.metadataStore.getEntityType("Order");
            var casesAndOrders = em1.getChanges([custType, orderType]);
        You can also ask for entities with a particular {{#crossLink "EntityState"}}{{/crossLink}} or EntityStates.
        @example
            // assume em1 is an EntityManager containing a number of preexisting entities.
            var custType = em1.metadataStore.getEntityType("Case");
            var orderType = em1.metadataStore.getEntityType("Order");
            var addedCasesAndOrders = em1.getEntities([custType, orderType], EntityState.Added);
        @method getEntities
